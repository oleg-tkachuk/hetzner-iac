...
// The perimeter: what may reach a node from outside the private network.
//
// Data rather than resources. internal/pkg/hetzner turns these into hcloud
// firewall rules and policy/ checks that nothing widens them, and neither of
// those is a reason for the rule set itself to need a cloud.
